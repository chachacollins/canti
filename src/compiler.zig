...
fn binary() !void {
    ...
    switch (operator_type) {
        ...
        .TOKEN_BANG_EQUAL => emitByte(@intFromEnum(Chunk.Op_Code.OP_BANG_EQUAL)),
        .TOKEN_GREATER => emitByte(@intFromEnum(Chunk.Op_Code.OP_GREATER)),
        .TOKEN_GREATER_EQUAL => emitByte(@intFromEnum(Chunk.Op_Code.OP_GREATER_EQUAL)),
        .TOKEN_LESS => emitByte(@intFromEnum(Chunk.Op_Code.OP_LESS)),
        .TOKEN_LESS_EQUAL => emitByte(@intFromEnum(Chunk.Op_Code.OP_LESS_EQUAL)),
